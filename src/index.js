...
import { start as enableXHRInterceptor } from './utils'
// 项目路由
import debugIndex from './demos/index'; //调试目录
import envSwitch from './env_switch/index'; //切换环境
import logHttp from './netlog/http/index'; // 网络日志列表
import logHttpDetail from './netlog/http/detail'; // 网络日志详情
